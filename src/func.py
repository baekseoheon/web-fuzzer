...
import sys, os, re, requests, queue, time, urllib3, websockets.client, concurrent.futures
...
def web_scan(url):
    ...
    print("==================================================")
    if not os.path.isdir("result_web_scan"):
        os.mkdir("result_web_scan")

    with open("result_web_scan/"+delschema(url)+"_web_scan.txt", "a+") as ff:
